# Hướng dẫn đóng góp cho PonyDownloader

Trước tiên, cảm ơn bạn đã quan tâm đến việc đóng góp cho PonyDownloader. Hướng dẫn này sẽ giúp bạn tham gia
phát triển PonyDownloader một cách tốt hơn.

## Mô tả nhánh

Dự án này chỉ có một nhánh chính duy nhất, đó là nhánh `main`. Nếu bạn muốn tham gia vào
phát triển PonyDownloader, hãy fork dự án này trước, sau đó phát triển trong dự án fork của bạn. Sau khi
