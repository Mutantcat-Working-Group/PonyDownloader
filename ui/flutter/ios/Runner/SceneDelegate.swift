...
class SceneDelegate: FlutterSceneDelegate {
  override func scene(
    ...
    forwardPonyDownloaderLinks(connectionOptions.urlContexts)
  }

  override func scene(_ scene: UIScene, openURLContexts URLContexts: Set<UIOpenURLContext>) {
    super.scene(scene, openURLContexts: URLContexts)
    forwardPonyDownloaderLinks(URLContexts)
  }

  private func forwardPonyDownloaderLinks(_ contexts: Set<UIOpenURLContext>) {
