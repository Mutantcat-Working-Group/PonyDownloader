...
@interface PonyDownloaderTaskEventForwarder () <LibgopeedTaskEventListener>

@property(nonatomic, strong) FlutterMethodChannel *channel;

@end

@interface PonyDownloaderInvokeResultForwarder : NSObject <LibgopeedInvokeResultListener>
...
@implementation PonyDownloaderInvokeResultForwarder
...
@interface PonyDownloaderNativeInvokeResultForwarder
...
@implementation PonyDownloaderNativeInvokeResultForwarder
...
@implementation PonyDownloaderTaskEventForwarder
...
- (void)onTaskEvent:(NSString * _Nullable)payload {
  ...
  if (@available(iOS 26.0, *)) {
    PonyDownloaderContinuedProcessingManager *manager =
        [PonyDownloaderContinuedProcessingManager shared];
  ...
  // custom PonyDownloader ActivityKit implementation.
  if (!continuedProcessingHandlesTask) {
    [[PonyDownloaderLiveActivityManager shared]
...
void PonyDownloaderInvokeAsyncWithResult(
  ...
  PonyDownloaderInvokeResultForwarder *forwarder =
      [[PonyDownloaderInvokeResultForwarder alloc] initWithResult:result];
  LibgopeedInvokeAsync(method, path, query, body, requestID, forwarder);
}

void PonyDownloaderInvokeAsyncNative(
    NSString *method,
    NSString *path,
    NSString *query,
    NSString *body,
  ...
  PonyDownloaderNativeInvokeResultForwarder *forwarder =
      [[PonyDownloaderNativeInvokeResultForwarder alloc]
