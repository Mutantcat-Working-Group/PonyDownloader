...
@available(iOS 26.0, *)
@objcMembers
final class PonyDownloaderContinuedProcessingManager: NSObject {

    static let shared = PonyDownloaderContinuedProcessingManager()
    ...
    func handleTaskEventPayload(
        ...
        // IMPORTANT: asynchronous, so PonyDownloader's event thread
