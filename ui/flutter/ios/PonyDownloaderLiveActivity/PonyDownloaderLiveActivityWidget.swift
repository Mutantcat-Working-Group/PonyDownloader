...
@main
struct PonyDownloaderLiveActivityBundle: WidgetBundle {
    var body: some Widget {
        PonyDownloaderLiveActivityWidget()
    }
}

struct PonyDownloaderLiveActivityWidget: Widget {

    var body: some WidgetConfiguration {

        ActivityConfiguration(
            for: PonyDownloaderDownloadAttributes.self
        ) { context in
    ...
    private func progressView(
        _ context:
            ActivityViewContext<PonyDownloaderDownloadAttributes>
    ) -> some View {
