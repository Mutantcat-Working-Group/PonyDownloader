...
import 'entry/ponydownloader_transport_stub.dart'
    if (dart.library.html) 'entry/ponydownloader_transport_web.dart'
    if (dart.library.io) 'entry/ponydownloader_transport_native.dart';

class PonyDownloaderTransportConfig {
  const PonyDownloaderTransportConfig({
...
PonyDownloaderTransport createPonyDownloaderTransport(PonyDownloaderTransportConfig config) => createTransport(config);
