...
import '../ponydownloader_transport.dart';

PonyDownloaderTransport createTransport(PonyDownloaderTransportConfig config) => RestPonyDownloaderTransport(config);

class RestPonyDownloaderTransport implements PonyDownloaderTransport {
  RestPonyDownloaderTransport(PonyDownloaderTransportConfig config)
    : _dio = Dio(
        BaseOptions(
