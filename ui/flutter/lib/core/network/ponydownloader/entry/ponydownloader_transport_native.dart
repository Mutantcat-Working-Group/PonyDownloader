...
PonyDownloaderTransport createTransport(PonyDownloaderTransportConfig config) => NativePonyDownloaderTransport();

class NativePonyDownloaderTransport implements PonyDownloaderTransport {
  NativePonyDownloaderTransport()
    : _externalDio = Dio(
        BaseOptions(
