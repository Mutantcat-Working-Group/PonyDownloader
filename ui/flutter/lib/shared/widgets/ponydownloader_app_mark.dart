  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: SizedBox.square(
        dimension: size,
        child: CustomPaint(
          painter: _PonyDownloaderAppMarkPainter(
...
class _PonyDownloaderAppMarkPainter extends CustomPainter {
  const _PonyDownloaderAppMarkPainter({required this.background, required this.foreground});
  ...
  @override
  bool shouldRepaint(_PonyDownloaderAppMarkPainter oldDelegate) {
