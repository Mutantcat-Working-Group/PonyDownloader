...
### 二、部署方式
1. 桌面端与移动端：从 [GitHub Releases](https://github.com/Mutantcat-Working-Group/PonyDownloader/releases) 下载对应平台安装包，安装后即可使用。
...
4. 开发者自行编译：需要 Go 1.25+ 与 Flutter 3.41+，后端使用 `go build`，前端使用 `flutter build`。
